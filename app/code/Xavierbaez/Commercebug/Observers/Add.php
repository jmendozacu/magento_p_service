...
class Add extends AbstractObserver
{
    ...
    public function __construct(
        ...
        \Xavierbaez\Commercebug\Model\LogFactory $logFactory,
        \Xavierbaez\Commercebug\Model\RenderedData $renderedData,        
        \Magento\Developer\Helper\Data $developerHelper,
        \Xavierbaez\Commercebug\Renderer\JsonFactory $jsonFactory,
    ...
    protected function getCommerceBugData($observer)
    {
        ...
        $cb_data = \Xavierbaez\Commercebug\Model\All::asData();
